...
<body>
	...
	<div style="widows: 100%;height: 100%;">
			...
			<center>
				<div id="menu-bar-2">
					<div style="width: auto;height: auto;padding: 4px 0px;">
						...
						<a href="../Login_before/login.html">Already a Member? Login!</a>
		...
		<div class="user_check">
			...
			<form action="forgot_change.php" method="post">
				<input class="field_look" style="margin-top: 10px; width: 96%; margin-left: 2%;margin-top: 1%" type="password" name="np" placeholder="Enter New Password">
				<input class="field_look" style="margin-top: 10px; width: 96%; margin-left: 2%;" type="password" name="rnp" placeholder="Re-Enter New Password">
				<input class="field_btn" style="margin-left: 43%; margin-top: 2%;" type="submit" value="Change">
			</form>
		</div>
