...
<body>
	...
	<div style="widows: 100%;height: auto;">
		...
		<div class="user_check">
			<form action="forgot_!.php" method="post">
				<input class="field_look" style="margin-top: 10px; width: 96%; margin-left: 2%;" class="form-control" type="text" name="user_name" placeholder="Enter UserName">
				<input class="field_look" style="margin-top: 10px; width: 96%; margin-left: 2%" class="form-control" type="email" name="user_email" placeholder="Enter EmailID">
